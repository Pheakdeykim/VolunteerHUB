    ...
    <>
      <nav className="fixed top-0 left-0 w-full h-full border-r bg-white space-y-8 sm:w-80">
        <div class="flex flex-col h-full">
          <div className="h-20 flex items-center px-8 text-2xl">
            <Link to="/" className="flex-none">
              <img
                src="/images/profileimg.png"
                className="mx-auto h-12 w-12 inline-block"
                alt="img"
              />{" "}
              VolunteerHUB
            </Link>
              ...
              <div className="py-4 px-4 border-t">
                <div className="flex items-center gap-x-4">
                  ...
                  <div>
                    ...
                    <Link
                      to="/userprofile"
                      className="block mt-px text-gray-600 hover:text-indigo-600 text-sm"
                    >
                      View profile
                    </Link>
                  </div>
