  ...
  return (
    <div className="grid grid-cols-6">
      ...
      <div className="col-span-5 w-full">
        ...
        <div>
          <div className="sticky top-0 bg-white ml-10 mb-5">
            <h1 className="font-bold text-3xl p-3">Settings</h1>
          </div>
          <div className="flex flex-col w-1/4 place-items-center mb-20 h-fit">
            <div>
              <img
              ...
              />
              <div className="flex flex-row w-full h-10 justify-center place-items-center">
                <h1 className="w-3/4 text-right text-2xl font-medium">
                  John Doe
                </h1>
                <div className="flex align-middle w-1/4 justify-center">
                  <Link to="/chat">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
          ...
          <ul className="w-3/4 border-r border-gray-400 pr-32 pt-5 text-lg">
            <div className="w-full pl-20">
              <li className="flex flex-row w-full my-10">
                <div className="mr-3 flex flex-col w-1/2 ">
                ...
                <div className="ml-3 flex flex-col w-1/2 justify-end ">
                  <div className="flex flex-row justify-end">
                    ...
                    <Link to="editprofilecd">
                      <button className="flex justify-end text-blue-600 hover:text-blue-800">
                        Edit
                      </button>
                    </Link>
                  </div>
              ...
              <li className="flex flex-row my-10 w-full">
