        ...
        <div class="container px-6 py-12 mx-auto">
          <div class="lg:flex lg:items-center lg:justify-center lg:-mx-6">
            <div class="lg:w-1/2 lg:mx-6 ">
              <h2 className="text-2xl font-semibold text-gray-800 capitalize dark:text-white lg:text-4xl mb-10 text-center">
              ...
              <div class="mt-6 space-y-8 md:mt-8">
                <p class="flex items-start -mx-2">
                  ...
                  <span class="mx-2 text-gray-700  w-fit dark:text-gray-400">
